              ...
              <?php
                if(isset($_POST['enviar'])){
                  ...
                  while($filas=mysqli_fetch_assoc($resultado)){
                    ...
                    <td data-label="ACCIONES" class="text-center"><?php echo '<a class="nav-button2" href="editar.php?folio='.$filas["folio"].'">EDITAR</a>';?> </br></br> <?php echo '<a class="nav-button2" href="eliminar.php?folio='.$filas["folio"].'" onclick= "return confirmar()">ELIMINAR</a>'; ?></td>
                  </tr>
              <?php
                  }
